module github.com/hv/akash.chandra/cloudeventtransform

go 1.19

require (
	github.com/knadh/koanf v1.5.0
	//github.com/hv/akash.chandra/cloudeventtransform v0.0.1
...
//replace github.com/hv/akash.chandra/cloudeventtransform v0.0.1 => ../cloudeventprocessor
